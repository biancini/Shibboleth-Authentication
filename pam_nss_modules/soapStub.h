...
/* ns2:oncallResponse */
struct ns2__oncallResponse
{
	char **salutation;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:string */
};
#endif
...
struct ns2__oncall
{
	char *loggeduser;	/* optional element of type xsd:string */
};
#endif
